...
def ask_ollama(prompt):
    ...
    data = {
        "model": "mistral",
        "prompt": "Asistan: Kisa cevap ver. Sadece Turkce cevap ver. Aciklama yapma.\n\nKullanici: " + prompt + "\nAsistan:",
        "stream": False,
        "options": {
            "num_predict": 2000,
            "temperature": 0.2
...
def receive_audio():
    ...
    subprocess.run(
    ["piper", "--model", "tr_TR-dfki-medium.onnx", "--output_file", "reply.wav"],
    stdin=open("text.txt", "r", encoding="utf-8")
    )
